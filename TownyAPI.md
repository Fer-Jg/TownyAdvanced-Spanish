...
2.  The new API which is present in Towny 0.94.0.1 and onwards (see new Javadoc for 0.97.1.0 [here](https://javadoc.jitpack.io/com/github/TownyAdvanced/Towny/0.97.1.0/javadoc/))
