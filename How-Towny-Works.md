...
-   [How Towny Works](#How_Towny_Works)
-   [The Hierarchy](#The_Hierarchy)
    -   [Nomads](#Nomads)
    -   [Residents](#Residents)
    -   [Towns](#Towns)
    -   [Mayors](#Mayors)
    ...
    -   [Nations](#Nations)
    -   [Kings](#Kings)
    -   [Configuring Townyperms.yml and the Roles of the Ranks Within](#Configuring_Townyperms.yml_and_the_Roles_of_the_Ranks_Within)
    -   [Configuring Mayor and King Titles, Town and Nation Names](#Configuring_Mayor_and_King_Titles,_Town_and_Nation_Names)
-   [How Towns Grow](#How_Towns_Grow)
    -   [Starting a Town](#Starting_a_Town)
    -   [Joining Towns](#Joining_Towns)
-   [Plot System of Land Ownership](#Plot_System_of_Land_Ownership)
    -   [Town Blocks](#Town_Blocks)
    -   [Plot Types](#Plot_Types)
    -   [Outposts](#Outposts)
    -   [Selling Land](#Selling_Land)
    -   [Using the Maps](#Using_the_Maps)
    -   [Plot Regeneration & Unclaimed Plots](#Plot_Regeneration_&_Unclaimed_Plots)
-   [How Towny Lets Players Protect Their Blocks](#How_Towny_Lets_Players_Protect_Their_Blocks)
    -   [Towny Plot Perms](#Towny_Plot_Perms)
    -   [Protection Additions Found in Towny Advanced](#Protection_Additions_Found_in_Towny_Advanced)
-   [How Towny Controls PVP Combat](#How_Towny_Controls_PVP_Combat)
    -   [Friendly-fire](#Friendly-fire)
    -   [Plot, Town and World PVP Settings](#Plot,_Town_and_World_PVP_Settings)
-   [Money](#Money)
    -   [Taxes and Upkeep](#Taxes_and_Upkeep)
    -   [Town and Nation Banks](#Town_and_Nation_Banks)
-   [Chat](#Chat)
    -   [Townychat.jar](#Townychat.jar)
    -   [Chatconfig.yml](#Chatconfig.yml)
    -   [Chat Channels](#Chat_Channels)
    -   [Kings' minions' prefixes and suffixes](#Kings'_minions'_prefixes_and_suffixes)
    -   [Spying on chat channels](#Spying_on_chat_channels)
-   [Multiworld](#Multiworld)
    -   [World Toggles](#World_Toggles)
-   [Towny War](#Towny_War)
    -   [/ta toggle war (Event War)](#/ta_toggle_war_(Event_War))
    -   [flag-war mode](#flag-war_mode)
-   [Using SQL instead of Flatfile](#Using_SQL_instead_of_Flatfile)
    -   [Configuring SQL](#Configuring_SQL)
    -   [Converting Flatfile to SQL](#Converting_Flatfile_to_SQL)
    -   [Converting SQL to Flatfile](#Converting_SQL_to_Flatfile)
